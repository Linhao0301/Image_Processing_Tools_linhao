...
class ImageAlphaBlendByBbox:
    ...
    def blend_images(self, base_image, overlay_image, bbox_format, bbox):
        # 确保输入是numpy数组
        ...
        for i in range(b):
            ...
            if x1 < w and y1 < h and x2 > 0 and y2 > 0:
                ...
                result[i, valid_y1:valid_y2, valid_x1:valid_x2, :3] = (
                    current_base * (1 - current_alpha) + current_rgb * current_alpha
                )
...
NODE_CLASS_MAPPINGS = {
    "ImageAlphaBlendByBbox": ImageAlphaBlendByBbox
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ImageAlphaBlendByBbox": "Image Alpha Blend By Bbox(linhao)"
} 